            ...
            <div className="relative w-full max-w-2xl max-h-[80vh] bg-slate-800 border border-white/10 rounded-2xl shadow-2xl flex flex-col overflow-hidden">
                ...
                <div className="flex-1 overflow-y-auto p-4">
                    ...
                    {!loading && !searched && (
                        <div className="text-center py-12">
                            ...
                            <p className="text-sm text-slate-400">Search for images to add to your flashcard.</p>
                        </div>
                    )}
                </div>
                ...
                <div className="px-4 py-2 border-t border-white/10">
                    <p className="text-[10px] text-slate-500 text-center">
                        Photos by <a href="https://unsplash.com" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-indigo-400">Unsplash</a>
                    </p>
                </div>
            </div>
        </div>
